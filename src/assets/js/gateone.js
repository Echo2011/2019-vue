...
GateOne.Logging.setLevel("debug");
...
GateOne.Base.update(GateOne.Net, {
    ...
    killTerminal: function(term) {
        console.log('GateOne.Net.killTerminal() is comming ,term id is '+ term);
...
GateOne.Base.update(GateOne.Visual, {
    ...
    init: function() {
        console.log("GateOne.Visual.init() is comming");
        /**:GateOne.Visual.init()
...
//         logDebug('applyTransform(' + typeof(obj) + ', ' + transform + ')');
    ...
    closeWorkspace: function(workspace, /*opt*/message) {
        console.log("GateOne.Visual.closeWorkspace(workspace) is comming ,workspace is :"+ workspace);
    ...
    cleanupWorkspaces: function() {
        ...
        */
       console.log("cleanupWorkspaces is comming");
        logDebug("GateOne.Visual.cleanupWorkspaces()");
        var u = go.Utils,
            v = go.Visual,
            workspaces = u.toArray(u.getNodes('.✈workspace'));
        workspaces.forEach(function(wsNode) {
